...
<body>
    ...
    <div class="navbar">
        <a href="consultar_asistencia.php"><i class="fas fa-calendar-check"></i> Consultar Asistencias</a>
        ...
        <div class="dashboard-container">
            <div class="dashboard-grid">
                ...
                <div class="card">
                    ...
                    <button onclick="window.location.href='ver_tareas.php'">Ver Tareas</button>
                </div>
            </div>
        </div>
    </div>
